...
north10.ndist <- apply(north.likelihoods.ndist.10, FUN = prod, MARGIN = 1)
south10.ndist <- apply(south.likelihoods.ndist.10, FUN = prod, MARGIN = 1)

north10.sdist <- apply(north.likelihoods.sdist.10, FUN = prod, MARGIN = 1)
south10.sdist <- apply(south.likelihoods.sdist.10, FUN = prod, MARGIN = 1)

# Create ratio & plot
hist(log10(north10.ndist/south10.ndist), xlab = "log10(north likelihood/south likelihood)", main = "", col = rgb(1,0,0,0.5), xlim = c(-12,10), ylim = c(0,300))
