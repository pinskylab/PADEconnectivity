...
mat2 <- data.matrix(mat * 100) # turn from proportion to percent
...
nocol <- 8
color <- rbPal(nocol)
ColorLevels <- seq(0, 70, length=length(color)) # this makes the color bar nicer later on
